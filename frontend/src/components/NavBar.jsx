      ...
      {isOpen && (  
        <div className="md:hidden bg-blue-700 py-4">
          <ul className="text-white text-center space-y-4 text-lg">
            ...
            <li><Link to="/manage-questions" className="block hover:text-gray-300" onClick={() => setIsOpen(false)}>Manage Questions</Link></li>
            <li><Link to="/manage-patterns" className="block hover:text-gray-300" onClick={() => setIsOpen(false)}>Patterns</Link></li>
            <li><Link to="/generate-paper" className="block hover:text-gray-300" onClick={() => setIsOpen(false)}>Generate Paper</Link></li>
            <li><Link to="reports" className="block hover:text-gray-300" onClick={() => setIsOpen(false)}>Reports</Link></li>
          </ul>
        </div>
      )}
    </nav>
